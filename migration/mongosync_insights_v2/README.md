...
```
Starting Mongosync Insights v2.0
...
Configure the application using environment variables. See **[docs/configuration.md](docs/configuration.md)** for the complete reference, including:
...
For production deployments, enable HTTPS encryption. See **[docs/security.md](docs/security.md)** for:
...
- **[docs/README.md](docs/README.md)** - Documentation index with links to all detailed guides
- **[CHANGELOG.md](CHANGELOG.md)** - Project history and version release notes
- **[docs/configuration.md](docs/configuration.md)** - Complete environment variables reference, configuration options, and MongoDB connection pooling
- **[docs/security.md](docs/security.md)** - HTTPS/SSL setup and connection-string handling security guidance
- **[docs/features/connection-setup.md](docs/features/connection-setup.md)** - Quick Setup vs Advanced behavior, implementation notes, and testing checklist
- **[docs/development.md](docs/development.md)** - Template structure and local development/testing notes
